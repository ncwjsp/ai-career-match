...
| C-02 - RAG context, hosted LLM explanations and validation | M3 | Not Started | SET-02; SET-03 for selected LLM access | Fixtures unblock development; use A-03/B-02/B-06 evidence at integration. | 0% |
